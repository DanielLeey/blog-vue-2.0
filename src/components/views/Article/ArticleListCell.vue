        ...
        <div class="ivu-row">
          ...
          >
            <div class="ivu-col ivu-col-span-7">
              <!--<div class="live-cover" style="background-image:'url('+ article.thumbnail +')"></div>-->
              <!--
                <div class="live-cover" :style="{background: 'url('+article.thumbnail+')',backgroundPosition:'center',backgroundSize:'100%'}"></div>
-->
              <img
                class="live-cover"
            ...
            <div class="ivu-col ivu-col-span-17">
              <div class="live-info">
                ...
                <div class="live-desc">{{ article.summary }}</div>
              </div>
              <div class="live-down">
